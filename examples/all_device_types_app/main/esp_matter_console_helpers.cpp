...
int create(uint8_t device_type_index)
{
    ...
    case ESP_MATTER_COLOR_TEMP_LIGHT: {
        ...
        endpoint = esp_matter::endpoint::color_temperature_light::create(node, &color_temperature_light_config,
    ...
    case ESP_MATTER_ON_OFF_LIGHT_SWITCH: {
        ...
        endpoint = esp_matter::endpoint::on_off_light_switch::create(node, &on_off_light_switch_config,
                                                                     ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    ...
    case ESP_MATTER_COLOR_DIMMER_SWITCH: {
        ...
        endpoint = esp_matter::endpoint::color_dimmer_switch::create(node, &color_dimmer_switch_config,
                                                                     ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_GENERIC_SWITCH: {
        esp_matter::endpoint::generic_switch::config_t generic_switch_config;
        generic_switch_config.switch_cluster.feature_flags =
    ...
    case ESP_MATTER_ON_OFF_PLUG_IN_UNIT: {
        ...
        endpoint = esp_matter::endpoint::on_off_plug_in_unit::create(node, &on_off_plug_in_unit_config,
                                                                     ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_DIMMABLE_PLUG_IN_UNIT: {
        esp_matter::endpoint::dimmable_plug_in_unit::config_t dimmable_plug_in_unit_config;
        endpoint = esp_matter::endpoint::dimmable_plug_in_unit::create(node, &dimmable_plug_in_unit_config,
                                                                       ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_FAN: {
    ...
    case ESP_MATTER_WINDOW_COVERING_DEVICE: {
        ...
        endpoint =
            esp_matter::endpoint::window_covering::create(node, &window_covering_config, ENDPOINT_FLAG_NONE, NULL);
    ...
    case ESP_MATTER_TEMP_SENSOR: {
        ...
        endpoint = esp_matter::endpoint::temperature_sensor::create(node, &temperature_sensor_config,
                                                                    ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_HUMIDITY_SENSOR: {
        ...
        endpoint =
            esp_matter::endpoint::humidity_sensor::create(node, &humidity_sensor_config, ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_OCCUPANCY_SENSOR: {
        ...
        endpoint =
            esp_matter::endpoint::occupancy_sensor::create(node, &occupancy_sensor_config, ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    ...
    case ESP_MATTER_PRESSURE_SENSOR: {
        ...
        endpoint =
            esp_matter::endpoint::pressure_sensor::create(node, &pressure_sensor_config, ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    ...
    case ESP_MATTER_PUMP: {
        ...
        pump_config.pump_configuration_and_control.feature_flags =
            cluster::pump_configuration_and_control::feature::constant_pressure::get_id();
    ...
    case ESP_MATTER_RAC: {
        ...
        endpoint = esp_matter::endpoint::room_air_conditioner::create(node, &room_air_conditioner_config,
                                                                      ENDPOINT_FLAG_NONE, NULL);

        // lets add fan control cluster
        esp_matter::cluster::fan_control::config_t fan_config;
        fan_config.fan_mode_sequence = 0;
        fan_config.fan_mode = 0;
        fan_config.percent_current = 0;

        cluster_t *fan_cluster = esp_matter::cluster::fan_control::create(endpoint, &fan_config, CLUSTER_FLAG_SERVER);
        if (!fan_cluster) {
            ESP_LOGE(TAG, "failed to add the fan-control cluster");
            return 1;
        }
    ...
    case ESP_MATTER_TEMP_CTRL_CABINET: {
        ...
        temperature_controlled_cabinet_config.temperature_control.feature_flags =
            cluster::temperature_control::feature::temperature_number::get_id();
        endpoint = esp_matter::endpoint::temperature_controlled_cabinet::create(
            node, &temperature_controlled_cabinet_config, ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_REFRIGERATOR: {
        ...
        temperature_controlled_cabinet_config.temperature_control.feature_flags =
            cluster::temperature_control::feature::temperature_number::get_id();
        esp_matter::endpoint_t *tcc_endpoint = esp_matter::endpoint::temperature_controlled_cabinet::create(
            node, &temperature_controlled_cabinet_config, ENDPOINT_FLAG_NONE, NULL);
    ...
    case ESP_MATTER_AIR_QUALITY_SENSOR: {
        ...
        endpoint = esp_matter::endpoint::air_quality_sensor::create(node, &air_quality_sensor_config,
                                                                    ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_ROBOTIC_VACUUM_CLEANER: {
        esp_matter::endpoint::robotic_vacuum_cleaner::config_t robotic_vacuum_cleaner_config;
        endpoint = esp_matter::endpoint::robotic_vacuum_cleaner::create(node, &robotic_vacuum_cleaner_config,
                                                                        ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    ...
    case ESP_MATTER_SMOKE_CO_ALARM: {
        ...
        esp_matter::endpoint_t *ps_endpoint =
            esp_matter::endpoint::power_source::create(node, &power_source_config, ENDPOINT_FLAG_NONE, NULL);
    ...
    case ESP_MATTER_WATER_LEAK_DETECTOR: {
        ...
        endpoint = esp_matter::endpoint::water_leak_detector::create(node, &water_leak_detector_config,
                                                                     ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_WATER_FREEZE_DETECTOR: {
        esp_matter::endpoint::water_freeze_detector::config_t water_freeze_detector_config;
        endpoint = esp_matter::endpoint::water_freeze_detector::create(node, &water_freeze_detector_config,
                                                                       ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    ...
    case ESP_MATTER_ELECTRICAL_SENSOR: {
        ...
        electrical_sensor_config.power_topology.feature_flags =
        ...
        endpoint =
            esp_matter::endpoint::electrical_sensor::create(node, &electrical_sensor_config, ENDPOINT_FLAG_NONE, NULL);
        ...
        if (endpoint) {
            ...
            esp_matter::cluster_t *energy_cluster = esp_matter::cluster::electrical_energy_measurement::create(
                endpoint, &electrical_energy_measurement, CLUSTER_FLAG_SERVER);

            if (!energy_cluster) {
                ESP_LOGE(TAG, "Failed to create electrical energy measurement cluster");
            }
            esp_matter::cluster_t *power_cluster =
                esp_matter::cluster::get(endpoint, chip::app::Clusters::ElectricalPowerMeasurement::Id);
            if (power_cluster) {
                esp_matter::cluster::electrical_power_measurement::attribute::create_voltage(power_cluster, NULL);
                esp_matter::cluster::electrical_power_measurement::attribute::create_active_current(power_cluster,
                                                                                                    NULL);
            }
    ...
    case ESP_MATTER_DEVICE_ENERGY_MANAGEMENT: {
        ...
        endpoint = esp_matter::endpoint::device_energy_management::create(node, &device_energy_management_config,
                                                                          ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_PUMP_CONTROLLER: {
        ...
        endpoint =
            esp_matter::endpoint::pump_controller::create(node, &pump_controller_config, ENDPOINT_FLAG_NONE, NULL);
        break;
    }
#ifdef CONFIG_OPENTHREAD_BORDER_ROUTER
    case ESP_MATTER_THREAD_BORDER_ROUTER: {
        ...
        GenericOpenThreadBorderRouterDelegate *delegate =
            chip::Platform::New<GenericOpenThreadBorderRouterDelegate>(&tbr_storage_delegate);
        if (!delegate) {
    ...
    case ESP_MATTER_MOUNTED_ON_OFF_CONTROL: {
        ...
        endpoint = esp_matter::endpoint::mounted_on_off_control::create(node, &mounted_on_off_control_config,
                                                                        ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_MOUNTED_DIMMABLE_LOAD_CONTROL: {
        ...
        endpoint = esp_matter::endpoint::mounted_dimmable_load_control::create(
            node, &mounted_dimmable_load_control_config, ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    ...
    case ESP_MATTER_BATTERY_STORAGE: {
        ...
        endpoint =
            esp_matter::endpoint::battery_storage::create(node, &battery_storage_config, ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    ...
    case ESP_MATTER_THERMOSTAT_CONTROLLER: {
        ...
        endpoint = esp_matter::endpoint::thermostat_controller::create(node, &thermostat_controller_config,
                                                                       ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    case ESP_MATTER_CLOSURE_CONTROLLER: {
        esp_matter::endpoint::closure_controller::config_t closure_controller_config;
        endpoint = esp_matter::endpoint::closure_controller::create(node, &closure_controller_config,
                                                                    ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    ...
    case ESP_MATTER_CLOSURE_PANEL: {
        ...
        closure_panel_config.closure_dimension.feature_flags =
            cluster::closure_dimension::feature::positioning::get_id();
    ...
    case ESP_MATTER_ELECTRICAL_ENERGY_TARIFF: {
        ...
        endpoint = esp_matter::endpoint::electrical_energy_tariff::create(node, &electrical_energy_tariff_config,
                                                                          ENDPOINT_FLAG_NONE, NULL);
    ...
    case ESP_MATTER_ELECTRICAL_METER: {
        ...
        electrical_meter_config.electrical_power_measurement.feature_flags =
            cluster::electrical_power_measurement::feature::direct_current::get_id();
        electrical_meter_config.electrical_energy_measurement.feature_flags =
        ...
        endpoint =
            esp_matter::endpoint::electrical_meter::create(node, &electrical_meter_config, ENDPOINT_FLAG_NONE, NULL);
        break;
    }
    ...
    if (!endpoint) {
        ...
        ESP_LOGI(TAG, "%s created with endpoint_id %d", device_type_list[device_type_index - 1].device_name,
...
static int create(int argc, char **argv)
{
    ...
    if (nerrors != 0) {
        ...
        ESP_LOGI(TAG,
                 "Please use: create --device_type=device_type where device type can be anyone from the below list:");
...
esp_err_t register_create_device_commands()
{
    ...
    const esp_console_cmd_t create_cmd = {.command = "create",
